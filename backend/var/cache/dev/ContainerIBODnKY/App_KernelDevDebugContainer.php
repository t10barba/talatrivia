...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->services['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('X9Fc5gwARx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $d = ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminRouteGenerator'] ?? self::getAdminRouteGeneratorService($container));
        $e = ($container->services['router'] ?? self::getRouterService($container));
        $f = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry([], [], [], []);
        $g = ($container->privates['debug.controller_resolver'] ?? self::getDebug_ControllerResolverService($container));

        return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'] = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\AdminRouterSubscriber(new \EasyCorp\Bundle\EasyAdminBundle\Factory\AdminContextFactory($container->targetDir.'', ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Factory\MenuFactory($b, $c, ($container->privates['security.logout_url_generator'] ?? self::getSecurity_LogoutUrlGeneratorService($container)), (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Menu\MenuItemMatcher((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), $d), $e), $f, new \EasyCorp\Bundle\EasyAdminBundle\Factory\EntityFactory($c, ($container->services['doctrine'] ?? self::getDoctrineService($container)), $a), $d, new \EasyCorp\Bundle\EasyAdminBundle\Factory\ActionFactory($b, $c, (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), ($container->privates['security.csrf.same_origin_token_manager'] ?? self::getSecurity_Csrf_SameOriginTokenManagerService($container)), new RewindableGenerator(fn () => new \EmptyIterator(), 0))), new \EasyCorp\Bundle\EasyAdminBundle\Factory\ControllerFactory($g), $g, $e, $e, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), $d, $container->targetDir.'', $f);
    }
