 ...
 */
class getNelmioAlice_Generator_Resolver_Value_Chainable_OptionalValueResolverService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_alice.generator.resolver.value.chainable.optional_value_resolver'] = new \Nelmio\Alice\Generator\Resolver\Value\Chainable\OptionalValueResolver(faker: ($container->services['Faker\\Generator'] ?? $container->load('getGeneratorService')));
    }
}
