...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'TalaTrivia API', 'description' => 'API REST para la plataforma de trivias TalaTrivia', 'version' => '1.0.0'], 'servers' => [['url' => 'http://localhost:8080', 'description' => 'Servidor de desarrollo']]]);
    }
}
