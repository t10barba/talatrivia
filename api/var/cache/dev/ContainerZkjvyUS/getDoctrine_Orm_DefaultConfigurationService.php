...
class getDoctrine_Orm_DefaultConfigurationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\PreguntaTriviaRepository' => ['privates', 'App\\Repository\\PreguntaTriviaRepository', 'getPreguntaTriviaRepositoryService', true],
            'App\\Repository\\RespuestaRepository' => ['privates', 'App\\Repository\\RespuestaRepository', 'getRespuestaRepositoryService', true],
            'App\\Repository\\RespuestaUsuarioRepository' => ['privates', 'App\\Repository\\RespuestaUsuarioRepository', 'getRespuestaUsuarioRepositoryService', true],
            'App\\Repository\\TriviaRepository' => ['privates', 'App\\Repository\\TriviaRepository', 'getTriviaRepositoryService', true],
            'App\\Repository\\UsuarioRepository' => ['privates', 'App\\Repository\\UsuarioRepository', 'getUsuarioRepositoryService', true],
            'App\\Repository\\UsuarioTriviaRepository' => ['privates', 'App\\Repository\\UsuarioTriviaRepository', 'getUsuarioTriviaRepositoryService', true],
        ], [
            'App\\Repository\\PreguntaRepository' => '?',
            'App\\Repository\\PreguntaTriviaRepository' => '?',
            'App\\Repository\\RespuestaRepository' => '?',
            'App\\Repository\\RespuestaUsuarioRepository' => '?',
            'App\\Repository\\TriviaRepository' => '?',
            'App\\Repository\\UsuarioRepository' => '?',
            'App\\Repository\\UsuarioTriviaRepository' => '?',
        ])));
